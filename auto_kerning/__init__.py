...
class TextObjectAutoKerning(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        apply_kerning(
            text_curve,
            bpy.path.abspath(text_curve.font.filepath),
            bpy.path.abspath(text_curve.font_bold.filepath),
            bpy.path.abspath(text_curve.font_italic.filepath),
            bpy.path.abspath(text_curve.font_bold_italic.filepath),
        )
